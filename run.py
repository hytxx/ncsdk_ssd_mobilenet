...
#    print(output.shape)
    ...
    for box_index in range(num_valid_boxes - 1):
            ...
            #if output[base_index + 1] != output[base_index_next + 1]:
...
#         4: box top location within image as number between 0.0 and 1.0
#         5: box right location within image as number between 0.0 and 1.0
#         6: boxth bottom location wiin image as number between 0.0 and 1.0
# returns None
...
cv_window_name = "SSD MobileNet - object detection"
...
#graph_file_name = 'models201808/mobilenet_hyt_201808061140_iter_7000_hyt.graph'
graph_file_name = 'mobilenet_iter_46000_hyt.graph'
...
cap = cv2.VideoCapture(0) #打开笔记本摄像头句柄
ret, infer_image = cap.read() #从摄像头获取每一帧图片
